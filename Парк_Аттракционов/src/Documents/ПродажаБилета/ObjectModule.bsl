...
Процедура ОбработкаПроведения(Отказ,Режим)
	...
	Движение.КоличествоПосещений = СвойстваНоменклатуры.КолличествоПосещений;
...
Функция ВидАттракциона(Номенклатура)
	...
	|	Номенклатура.КолличествоПосещений
	|ИЗ
	...
	Результат.Вставить("КолличествоПосещений", Выборка.КолличествоПосещений);
