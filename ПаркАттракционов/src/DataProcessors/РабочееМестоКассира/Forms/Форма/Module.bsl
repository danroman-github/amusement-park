...
// Заполнить избранные товары клиента.
&НаСервере
Процедура ЗаполнитьИзбранныеТоварыКлиента()
	
	СброситьИзбранныеТовары();

	Выборка = ПродажиОборотыНоменклатурыКлиента();
...
// Продажи обороты номенклатуры клиента.
// 
// Возвращаемое значение:
//  ВыборкаИзРезультатаЗапроса - Продажи обороты номенклатуры клиента:
//  *Номенклатура - СправочникСсылка.Номенклатура
//
&НаСервере
Функция ПродажиОборотыНоменклатурыКлиента()
...
// Заполнить декорации избранных элементов.
&НаСервере
...
// Заполнить декорацию баллы клиента.
// 
...
Процедура ЗаполнитьДекорациюБаллыКлиента()
	...
	Выборка = ВыборкаОстатокБонусныхБалловКлиента();
...
// Выборка остаток бонусных баллов клиента.
// 
// Возвращаемое значение:
//  ВыборкаИзРезультатаЗапроса - Выборка остаток бонусных баллов клиента:
//  *СуммаОстаток - Число
//
&НаСервере
Функция ВыборкаОстатокБонусныхБалловКлиента()
