...
Процедура ОбработкаПроведения(Отказ,Режим)
	...
	Выборка = ВыборкаПродажаБилетаПозицииПродажи();
	...
	Пока Выборка.Следующий() Цикл
		...
		ДвижениеАктивныеПосещения.ВидАттракциона = Выборка.ВидАттракциона; // ВидАттракциона - СправочникСсылка.ВидыАттракционов
...
Процедура НачислитьСписатьБонусныеБаллы(Отказ)
	...
	ДоляНакапливаеммыхБаллов = ДоляНакапливаеммыхБаллов(СуммаПокупокКлиента);
	
	БаллыКНакоплению = СуммаДокумента * ДоляНакапливаеммыхБаллов / 100;
	...
	Выборка = ОстатокБонусныхБалловКлиента();
...
// Остаток бонусных баллов клиента.
// 
// Возвращаемое значение:
//  ВыборкаИзРезультатаЗапроса - Остаток бонусных баллов клиента:
//  *СуммаОстаток - Число
//
Функция ОстатокБонусныхБалловКлиента()
...
Функция СуммаПокупокКлиента()
	...
	Выборка = ПродажиОборотыСуммаОборот();
...
// 
// Возвращаемое значение:
//  ВыборкаИзРезультатаЗапроса - Сумма покупок клиента:
//  *СуммаОборот - Число
//
Функция ПродажиОборотыСуммаОборот()
...
// Доля накапливаеммых баллов.
// 
// Параметры:
//  СуммаПокупокКлиента - Число - Сумма покупок клиента
// 
// Возвращаемое значение:
//  Число - Доля накапливаеммых баллов
Функция ДоляНакапливаеммыхБаллов(СуммаПокупокКлиента)
	
	Выборка = ШкалаБонуснойПрограммыПроцентНакопления(СуммаПокупокКлиента);
...
// Шкала бонусной программы процент накопления.
// 
// Параметры:
//  СуммаПокупокКлиента - Число - Сумма покупок клиента
// 
// Возвращаемое значение:
//  ВыборкаИзРезультатаЗапроса - Шкала бонусной программы процент накопления:
//  *ПроцентНакопления - Число
//
Функция ШкалаБонуснойПрограммыПроцентНакопления(СуммаПокупокКлиента)
...
// Выборка продажа билета позиции продажи.
// 
// Возвращаемое значение:
//  ВыборкаИзРезультатаЗапроса - Выборка продажа билета позиции продажи:
//  *ВидАттракциона - СправочникСсылка.ВидыАттракционов
//  *Номенклатура - СправочникСсылка.Номенклатура
//  *КоличествоПосещений - Число
//  *Сумма - Число
//
Функция ВыборкаПродажаБилетаПозицииПродажи()
